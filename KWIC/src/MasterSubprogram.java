...
public class MasterSubprogram {
    ...
    public static void run() {
        ...
        MasterSubprogram kwic = new MasterSubprogram();
        kwic.input("D:\\STUDY\\软件体系结构\\lab2input.txt");
        kwic.shift();
        kwic.alphabetizer();
        kwic.output("D:\\STUDY\\软件体系结构\\lab2output.txt");
    }
