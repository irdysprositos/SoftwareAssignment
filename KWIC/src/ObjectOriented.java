...
public class ObjectOriented {
    ...
    class Output {
        ...
        public static void run() {
            ...
            Input input = obj.new Input();
            input.input("D:\\STUDY\\软件体系结构\\lab2input.txt");
            Shift shift = obj.new Shift(input.getLineTxt());
            shift.shift();
            Alphabetizer alphabetizer = obj.new Alphabetizer(shift.getKwicList());
            alphabetizer.sort();
            Output output = obj.new Output(alphabetizer.getKwicList());
            output.output("D:\\STUDY\\软件体系结构\\lab2output.txt");
